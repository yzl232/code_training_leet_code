class Solution:
    ...
    def findMedianSortedArrays(self, A, B):
        ...
        if (lenA + lenB)  % 2 ==1: return self.getMedian(A, B, (lenA + lenB)/2+1)
        else: return 0.5 * (self.getMedian(A, B, (lenA + lenB)/2) + self.getMedian(A, B, (lenA + lenB)/2 + 1))
    def getMedian(self, A, B, k):
        ...
        pa = min(k/2, lenA); pb = k-pa     ##normal case pa =  k /2 .  Special case:  pa = lenA
